...
interface ListMyCollectionTaskParamsType {
...
*/
interface ListMyCollectionTaskResponse {
  taskId: number;
  systemId: number;
  createOrgId: number;
 ...
 * @returns
 */
function listMyCollectionTask(params: ListMyCollectionTaskParamsType) {
  return SurveyService.post<CommonResponseType<ListMyCollectionTaskResponse[]>>(
    `${baseUrl}/task/listMyCollectionTask`,
    {
      ...params,
    }
  );
...
export default listMyCollectionTask;
